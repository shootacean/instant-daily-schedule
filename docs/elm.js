...
var $author$project$Main$init = _Utils_Tuple2(
	{
		editingTask: {end: $elm$core$Maybe$Nothing, estimate: '', start: $elm$core$Maybe$Nothing, title: 'Hello'},
			...
			[
				{
					...
					A2(
						...
						$elm$time$Time$utc,
						A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 6, 30, 0, 0))),
				estimate: '',
				start: $elm$core$Maybe$Just(
					A2(
						$justinmimbs$time_extra$Time$Extra$partsToPosix,
						$elm$time$Time$utc,
						A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 6, 0, 0, 0))),
				title: 'Wakeup'
			},
				{
				end: $elm$core$Maybe$Just(
					A2(
						$justinmimbs$time_extra$Time$Extra$partsToPosix,
						$elm$time$Time$utc,
						A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 13, 15, 0, 0))),
				estimate: '01:00',
				start: $elm$core$Maybe$Just(
					A2(
						$justinmimbs$time_extra$Time$Extra$partsToPosix,
						$elm$time$Time$utc,
						A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 12, 0, 0, 0))),
				title: 'Lunch'
			},
				{
				...
				start: $elm$core$Maybe$Just(
					A2(
						$justinmimbs$time_extra$Time$Extra$partsToPosix,
						$elm$time$Time$utc,
						A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 19, 0, 0, 0))),
				title: 'Dinner'
			}
			])
	},
...
var $author$project$Main$Task = F4(
	function (title, start, end, estimate) {
		return {end: end, estimate: estimate, start: start, title: title};
	});
...
var $author$project$Main$splitTimeStringToHourMinute = function (time) {
	var s = A2($elm$core$String$split, ':', time);
	var m = A2(
		...
		$elm$core$String$toInt(
			A2(
				$elm$core$Maybe$withDefault,
				'',
				A2($elm_community$list_extra$List$Extra$getAt, 1, s))));
	var h = A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toInt(
			A2(
				$elm$core$Maybe$withDefault,
				'',
				A2($elm_community$list_extra$List$Extra$getAt, 0, s))));
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AddTask':
				var i = msg.a;
				var secondHalf = A2($elm$core$List$drop, i + 1, model.tasks);
				var firstHalf = A2($elm$core$List$take, i + 1, model.tasks);
				var _new = A2(
					...
					A2(
						...
						_List_fromArray(
							[
								A4($author$project$Main$Task, '', $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, '')
							]),
						secondHalf));
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'DeleteTask':
				var i = msg.a;
				var _new = A2($elm_community$list_extra$List$Extra$removeAt, i, model.tasks);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tasks: _new}),
			...
			case 'SwapTask':
				var me = msg.a;
				var to = msg.b;
				var _new = A3($elm_community$list_extra$List$Extra$swapAt, me, to, model.tasks);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{tasks: _new}),
			...
			case 'ChangeTaskTitle':
				var i = msg.a;
				var value = msg.b;
				var _v1 = A2($elm_community$list_extra$List$Extra$getAt, i, model.tasks);
				if (_v1.$ === 'Just') {
					var task = _v1.a;
					var newTask = _Utils_update(
						task,
						{title: value});
					var newTasks = A3($elm_community$list_extra$List$Extra$setAt, i, newTask, model.tasks);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{tasks: newTasks}),
			...
			case 'ChangeTaskStart':
				var i = msg.a;
				var value = msg.b;
				var _v2 = A2($elm_community$list_extra$List$Extra$getAt, i, model.tasks);
				if (_v2.$ === 'Just') {
					var task = _v2.a;
					var _v3 = $author$project$Main$splitTimeStringToHourMinute(value);
					var h = _v3.a;
					var m = _v3.b;
					var today = A2(
						$justinmimbs$time_extra$Time$Extra$partsToPosix,
						$elm$time$Time$utc,
						A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, h, m, 0, 0));
					var newTask = _Utils_update(
						task,
						{
							start: $elm$core$Maybe$Just(today)
						});
					var newTasks = A3($elm_community$list_extra$List$Extra$setAt, i, newTask, model.tasks);
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'ChangeTaskEnd':
				var i = msg.a;
				var value = msg.b;
				var _v4 = A2($elm_community$list_extra$List$Extra$getAt, i, model.tasks);
				if (_v4.$ === 'Just') {
					var task = _v4.a;
					var _v5 = $author$project$Main$splitTimeStringToHourMinute(value);
					var h = _v5.a;
					var m = _v5.b;
					var today = A2(
						$justinmimbs$time_extra$Time$Extra$partsToPosix,
			...
			default:
				var i = msg.a;
				var value = msg.b;
				var _v6 = A2($elm_community$list_extra$List$Extra$getAt, i, model.tasks);
				if (_v6.$ === 'Just') {
					var task = _v6.a;
					var newTask = _Utils_update(
						task,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$href('https://github.com/shootacean/instant-daily-scheduler')
								]),
							_List_fromArray(
								[
...
var $author$project$Main$ChangeTaskEnd = F2(
	function (a, b) {
		return {$: 'ChangeTaskEnd', a: a, b: b};
	});
var $author$project$Main$ChangeTaskEstimate = F2(
	function (a, b) {
		return {$: 'ChangeTaskEstimate', a: a, b: b};
	});
var $author$project$Main$ChangeTaskStart = F2(
	function (a, b) {
		return {$: 'ChangeTaskStart', a: a, b: b};
	});
var $author$project$Main$ChangeTaskTitle = F2(
	function (a, b) {
		return {$: 'ChangeTaskTitle', a: a, b: b};
	});
var $author$project$Main$DeleteTask = function (a) {
	return {$: 'DeleteTask', a: a};
};
var $author$project$Main$SwapTask = F2(
	function (a, b) {
		return {$: 'SwapTask', a: a, b: b};
	});
...
var $author$project$Main$convertPosixToTimeString = function (maybePosix) {
	if (maybePosix.$ === 'Just') {
		var p = maybePosix.a;
		var part = A2($justinmimbs$time_extra$Time$Extra$posixToParts, $elm$time$Time$utc, p);
		var m = A3(
			$elm$core$String$padLeft,
			2,
			_Utils_chr('0'),
			$elm$core$String$fromInt(part.minute));
		var h = A3(
			$elm$core$String$padLeft,
			2,
			_Utils_chr('0'),
			$elm$core$String$fromInt(part.hour));
		return h + (':' + m);
	} else {
		return '';
	}
...
var $author$project$Main$calcActual = function (t) {
	var s = A2(
		$elm$core$Maybe$withDefault,
		A2(
			$justinmimbs$time_extra$Time$Extra$partsToPosix,
			$elm$time$Time$utc,
			A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 0, 0, 0, 0)),
		t.start);
	var e = A2(
		$elm$core$Maybe$withDefault,
		A2(
			...
			A7($justinmimbs$time_extra$Time$Extra$Parts, 2021, $elm$time$Time$Jan, 1, 0, 0, 0, 0)),
		t.end);
	var m = A4($justinmimbs$time_extra$Time$Extra$diff, $justinmimbs$time_extra$Time$Extra$Minute, $elm$time$Time$utc, s, e);
	var hour = A3(
		$elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
		$elm$core$String$fromInt((m / 60) | 0));
	var minute = A3(
		$elm$core$String$padLeft,
		2,
		_Utils_chr('0'),
...
var $author$project$Main$viewActual = function (t) {
	var _v0 = $author$project$Main$calcActual(t);
	var hour = _v0.a;
	var minute = _v0.b;
	return (_Utils_eq(t.start, $elm$core$Maybe$Nothing) || _Utils_eq(t.end, $elm$core$Maybe$Nothing)) ? '-' : (hour + (':' + minute));
};
var $elm$html$Html$i = _VirtualDom_node('i');
var $elm$html$Html$span = _VirtualDom_node('span');
var $author$project$Main$viewIcon = function (iconClass) {
	return A2(
		$elm$html$Html$span,
		_List_fromArray(
			[
...
var $author$project$Main$viewReal = function (t) {
	var _v0 = $author$project$Main$calcActual(t);
	var hour = _v0.a;
	var minute = _v0.b;
	return (!_Utils_eq(t.end, $elm$core$Maybe$Nothing)) ? (hour + (':' + minute)) : ((t.estimate !== '') ? t.estimate : '-');
};
var $author$project$Main$viewScheduleRecord = F2(
	function (t, i) {
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									A2($author$project$Main$SwapTask, i, i - 1))
								]),
							_List_fromArray(
								[
									$author$project$Main$viewIcon('fas fa-arrow-up')
								]))
						])),
					A2(
					$elm$html$Html$td,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Main$viewIcon('fas fa-arrow-down')
								]))
						])),
					A2(
					$elm$html$Html$td,
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Main$ChangeTaskTitle(i)),
									$elm$html$Html$Attributes$value(t.title)
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onInput(
									$author$project$Main$ChangeTaskStart(i)),
									$elm$html$Html$Attributes$value(
									$author$project$Main$convertPosixToTimeString(t.start))
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$type_('time'),
									$elm$html$Html$Events$onInput(
									$author$project$Main$ChangeTaskEnd(i)),
									$elm$html$Html$Attributes$value(
									$author$project$Main$convertPosixToTimeString(t.end))
								]),
							_List_Nil)
						])),
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Attributes$type_('time'),
									$elm$html$Html$Events$onInput(
									$author$project$Main$ChangeTaskEstimate(i)),
									$elm$html$Html$Attributes$value(t.estimate)
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Main$viewActual(t))
								]))
						])),
					A2(
					$elm$html$Html$td,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									$author$project$Main$viewReal(t))
								]))
						])),
					A2(
					$elm$html$Html$td,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('delete is-medium'),
									$elm$html$Html$Events$onClick(
									$author$project$Main$DeleteTask(i))
								]),
							_List_Nil)
						]))
				]));
	});
var $author$project$Main$viewScheduleRecords = function (tasks) {
	return A3(
		$elm$core$List$map2,
		$author$project$Main$viewScheduleRecord,
		tasks,
		A2(
			$elm$core$List$range,
			0,
...
var $author$project$Main$viewScheduleTable = function (tasks) {
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$tbody,
				_List_Nil,
				$author$project$Main$viewScheduleRecords(tasks))
			]));
};
var $author$project$Main$viewSchedule = function (m) {
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewScheduleTable(m.tasks)
			]));
};
var $author$project$Main$viewMain = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('px-3 py-3')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$author$project$Main$viewSchedule(model)
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewMain(m),
